...
To summarize when to use comments:

1. Sparingly use inline comments to explain complex logic.
2. Use JSDoc to document on all classes, all public functions but not on private functions. Dont be overly verbose, just enough to be useful.
3. If you are using inline comments, consider first if you can write some utility functions to make the code more self-documenting.